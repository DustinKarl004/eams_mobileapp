...
const ViewOtherApplicantInfo = () => {
  ...
  const fetchExistingData = async (email) => {
    try {
      ...
      if (freshmenDocSnap.exists()) {
        ...
        setApplicantInfo(data.other_applicant_info || {});
  ...
  const handleNextPress = () => {
    navigation.navigate('ViewSectorAndWorkStatus');
  };
        ...
        {isLoading ? (
          ...
          <ScrollView contentContainerStyle={styles.scrollContent}>
            <View style={styles.formContainer}>
              ...
              <InfoField label="Citizenship" value={applicantInfo?.citizenship} icon="flag-outline" />
              <InfoField label="Gender" value={applicantInfo?.gender} icon="person-outline" />
              <InfoField label="Religion" value={applicantInfo?.religion} icon="book-outline" />
              <InfoField label="Civil Status" value={applicantInfo?.civil_status} icon="heart-outline" />
            </View>
          </ScrollView>
        )}
...
export default ViewOtherApplicantInfo;
