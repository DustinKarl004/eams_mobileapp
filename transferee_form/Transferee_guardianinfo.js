...
const TransfereeGuardianInfo = () => {
  ...
  const fetchExistingData = async (email) => {
    try {
      ...
      if (docSnap.exists()) {
        ...
        setGuardianSuffix(guardianData.guardian_suffix || '');
  ...
  const handleNextPress = async () => {
    ...
    try {
      ...
      setIsLoading(false);
      navigation.navigate('TransfereeEducation');
    } catch (error) {
...
export default TransfereeGuardianInfo;
