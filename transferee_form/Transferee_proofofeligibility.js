...
const TransfereeProofOfEligibility = () => {
  ...
  const handleNextPress = async () => {
    ...
    try {
      ...
      const storageRef = ref(storage, `uploads/transferee_proof_of_eligibility/${userEmail}`);
      ...
      setIsLoading(false);
      navigation.navigate('TransfereeFamilyInformation');
    } catch (error) {
...
export default TransfereeProofOfEligibility;
