          ...
          setError(
            <View style={[styles.enhancedStatusContainer, { backgroundColor: '#ffc107' }]}>
              ...
              <Text style={[styles.enhancedStatusText, { color: '#000000' }]}>
                You can now start your transferee application process.
              </Text>
            </View>
          );
        }
  ...
  const handleNextPress = async () => {
    if (checked && canProceed) {
      ...
      try {
        ...
        navigation.navigate('TransfereeApplicantInformation');
      } catch (error) {
                  ...
                  {isLoading || isCheckingCollections ? (
                    ...
                    <>
                      <Text style={styles.nextButtonText}>
                        {isTransferee && isComplete ? 'Done' : 'Next'}
                      </Text>
...
export default TransfereeScreen;